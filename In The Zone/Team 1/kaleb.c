...
#pragma config(Motor,  port3,           FC,            tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port8,           BC,            tmotorVex393_MC29, openLoop)
...
void setMotorSpeed(int x, int rotate, int y) {
	...
	motor[FC] = motor[BC] = correctJoystick(minDriveSpeed, y);
}
