...
#pragma config(Motor,  port1,           driveRFront,   tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port2,           driveLFront,   tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port3,           driveRCenter,          tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           intake,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           launcher,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           driveRBack,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           driveLCenter,          tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           driveLBack,    tmotorVex393_MC29, openLoop, reversed)
...
void pre_auton()
{
  ...
  slaveMotor(driveLBack, driveLFront);
  slaveMotor(driveLCenter, driveLFront);

  slaveMotor(driveRBack, driveRFront);
  slaveMotor(driveRCenter, driveRFront);
...
void armPID(int target, bool reset) {
	...
	int error = target - nMotorEncoder[armL];
...
*/
		...
		motor[intake] = (vexRT[Btn6U] - vexRT[Btn6D]) * intakeSpeed;
  	...
  	motor[launcher] = (vexRT[Btn7D] - vexRT[Btn7U]) * launcherSpeed;
	}
}
